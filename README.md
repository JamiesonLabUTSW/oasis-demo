...
| Join the hosted MAPLES demo | [Participant guide](https://jamiesonlabutsw.github.io/oasis-demo/hosted-guide.html) · [Offline copy](hosted-guide.html) — prepared-example quick start, rubric editing and host-assisted data uploads; assigned access from the facilitator |
